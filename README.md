...
Use a batch collected with extension version 0.5.0 or newer so the locked Source Page Context includes the Chrome document identity. Native Favorite success requires exact Platform Identity confirmation in the Boss favorite-management experience. A safe explicit failure may retry once; unknown and platform-restriction outcomes never auto-retry. This version does not refresh the recommendation page, advance to another Capture Batch, contact candidates, or cancel favorites.
